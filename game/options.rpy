...
define config.name = _("Gathering Storm of Griffonian Empire")
...
define build.name = "GatheringStormofGriffonianEmpire"
...
define config.save_directory = "GatheringStormofGriffonianEmpire-1751433851"
